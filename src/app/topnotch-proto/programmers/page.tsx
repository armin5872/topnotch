...
const info = [
  ...
  {
    name: 'Vladmir Varkszi | alias : МИРОТВОРЦ ( Meaning : The Peacemaker )',
    profession: 'Pro Backend DEV',
    description:
      'has mastered all the technoligies in the backend field think of any backend tech and this guy will know it, both know it and has mastered it whatever if its ExpressJS, NextJS, Laravel, PHP, Django, NodeJS just whatever.',
    link: '/vladmir.png',
  },
  {
    name: "John Doe (don't ask any questions about his name he is a true artist)",
    profession: 'Master programmer',
    description:
      'The CEO of Topnotch INC and the genius behind our websites and a great leader that leads us to success',
    link: '/john.png',
  },
]
